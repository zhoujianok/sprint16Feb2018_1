...
//    $("#hidMinL").val(Math.round(data.values.min));
//    $("#hidMaxL").val(Math.round(data.values.max));
//});

$("#slider2").editRangeSlider({
    bounds: { min: -60, max: 60 },
    formatter: function (val) {
        var value = Math.round(val * 10) / 10,
            decimal = value - Math.round(val);
        return decimal == 0 ? value.toString() + ".0" : value.toString();
...
$('.multipleSelect3').fastselect();
$('.multipleSelect4').fastselect();
$('.multipleSelect5').fastselect();
$('.multipleSelect6').fastselect();
...
//    $(".new-slide-box").toggleClass('span9').removeClass('span-new');


//});

  
function quandoClicarNoBotaoMenu() {
    $("#menu").toggleClass("aberto")
}

$("#botaoMenu").on("click", quandoClicarNoBotaoMenu);
...
//for select all
//ddlFibreType
$("#ddlFibreType").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlFibreType option[value='All']").prop("selected", false);
        $('#ddlFibreType option').prop('selected', true);
        $("#ddlFibreType option[value='All']").prop("selected", false);
    }
    $('#ddlFibreType').trigger("chosen:updated");
});
//ddlFibre
$("#ddlFibre").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlFibre option[value='All']").prop("selected", false);
        $('#ddlFibre option').prop('selected', true);
        $("#ddlFibre option[value='All']").prop("selected", false);
    }
    $('#ddlFibre').trigger("chosen:updated");
});
//ddlBrand
$("#ddlBrand").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlBrand option[value='All']").prop("selected", false);
        $('#ddlBrand option').prop('selected', true);
        $("#ddlBrand option[value='All']").prop("selected", false);
    }
    $('#ddlBrand').trigger("chosen:updated");
});
//ddlWPercent
$("#ddlWPercent").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlWPercent option[value='All']").prop("selected", false);
        $('#ddlWPercent option').prop('selected', true);
        $("#ddlWPercent option[value='All']").prop("selected", false);
    }
    $('#ddlWPercent').trigger("chosen:updated");
});
//ddlFiberOrigin
$("#ddlFiberOrigin").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlFiberOrigin option[value='All']").prop("selected", false);
        $('#ddlFiberOrigin option').prop('selected', true);
        $("#ddlFiberOrigin option[value='All']").prop("selected", false);
    }
    $('#ddlFiberOrigin').trigger("chosen:updated");
});
//ddlGroup
$("#ddlGroup").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlGroup option[value='All']").prop("selected", false);
        $('#ddlGroup option').prop('selected', true);
        $("#ddlGroup option[value='All']").prop("selected", false);
    }
    $('#ddlGroup').trigger("chosen:updated");
});
//ddlProcessingTime
$("#ddlProcessingTime").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlProcessingTime option[value='All']").prop("selected", false);
        $('#ddlProcessingTime option').prop('selected', true);
        $("#ddlProcessingTime option[value='All']").prop("selected", false);
    }
    $('#ddlProcessingTime').trigger("chosen:updated");
});

//ddlDeveloperStrength
$("#ddlDeveloperStrength").change(function () {
    var end = this.value;
    if (end == "All") {
        $("#ddlDeveloperStrength option[value='All']").prop("selected", false);
        $('#ddlDeveloperStrength option').prop('selected', true);
        $("#ddlDeveloperStrength option[value='All']").prop("selected", false);
    }
    $('#ddlDeveloperStrength').trigger("chosen:updated");
});
